...
ne.init = function(self)
        ...
        ass:new_event()
        ass:pos(self.geo.x-46, self.geo.y-57)
        ass:append('{\\1c&HFFFFFF&\\bord0&\\4a&HFF&\\p1}')
        ass:draw_start()
        ass:append('m 492.5 0 l 738.5 0 l 738.5 589 b 738.5 689 722.5 764.5 690 816 b 626.5 919 518.5 980 373 980 b 292.5 980 223.5 964.5 167.5 932 b 54.5 865.5 0 776 0 590 l 0 0 l 245.5 0 l 245.5 586 b 245.5 706 283.5 764.5 370.5 764.5 b 453.5 764.5 492.5 722.5 492.5 587.5 l 492.5 0')
        ass:draw_stop()
        
        ass:new_event()
        ass:pos(self.geo.x, player.geo.height - 20)
        ass:an(2)
        ass:append('{3c&HFFFFFF&\\q2\\4a&HFF&}Drag in a file, or right click and open something.')
